...
@Composable
fun CreateAccountWithPhoneScreen(
...
private fun CreateContent(
    ...
    ConstraintLayout(modifier = Modifier.fillMaxSize()) {
        ...
        ElevatedTextField(
            ...
            defaultElevation = 5.dp,
            pressedElevation = 10.dp,
            modifier = Modifier.constrainAs(phoneNumberRef) {
        ...
        Row(
            ...
            modifier = Modifier
                .clickable(
                    onClick = {
                        onTriggerEvent(
                            CreateAccountEvent.PhoneAuthData(
                                firstname,
                                lastname,
                                phoneNumber
                            )
        ...
        LaunchedEffect(firstname, lastname, phoneNumber) {
            verifyCredentials(CreateAccountEvent.PhoneAuthData(firstname, lastname, phoneNumber))
        }
    }
}