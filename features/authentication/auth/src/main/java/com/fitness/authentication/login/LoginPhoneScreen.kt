...
fun LoginWithPhoneScreen(
    state: StateFlow<BaseViewState<LoginState>> = MutableStateFlow(BaseViewState.Empty),
    ...
    when (uiState) {
        ...
        is BaseViewState.Data -> {
            LoginContent(
                uiState.cast<BaseViewState.Data<LoginState>>().value,
                onTriggerEvent,
                onEmailEvent,
...
private fun LoginContent(
    ...
    ConstraintLayout(modifier = Modifier.fillMaxSize()) {
        ...
        val mid40Guideline = createGuidelineFromTop(.4f)
        ...
        Text(text = stringResource(id = R.string.continue_your_journey),
            ...
            modifier = Modifier.constrainAs(subtitleRef) {
                bottom.linkTo(mid40Guideline, 25.dp)
        ...
        Row(
            ...
            modifier = Modifier
                .clickable(
                    onClick = {
                        onTriggerEvent(LoginEvent.PhoneAuthData(phone))
                    },
                ...
                })
        {
            ...
            ElevatedIconButton(
                ...
                onClick = {onTriggerEvent(LoginEvent.PhoneAuthData(phone))},
                enabled = uiState.isVerified
            )
        }
        ...
        LaunchedEffect(phone) {
            verifyCredentials(LoginEvent.PhoneAuthData(phone))
        }
    }
}
