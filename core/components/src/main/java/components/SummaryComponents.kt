...
enum class HealthSummaryConfiguration {
    SQUARE,
    SQUARE_DETAILED,
    HORIZONTAL,
    VERTICAL
...
@Composable
fun HealthSummaryComponent(configuration: HealthSummaryConfiguration, modifier: Modifier) {
    when (configuration) {
        HealthSummaryConfiguration.SQUARE -> SquareHealthSummaryComponent(modifier = modifier)
        HealthSummaryConfiguration.SQUARE_DETAILED -> DetailedSummaryComponent(modifier = modifier)
        HealthSummaryConfiguration.HORIZONTAL -> HorizontalHealthSummaryComponent(modifier = modifier)
        HealthSummaryConfiguration.VERTICAL -> VerticalHealthTrackingSummary(modifier = modifier)
    }
}
...
private fun SquareHealthSummaryComponent(
    ...
    ShapifyTheme {
        Card(
            ...
            ConstraintLayout(Modifier.padding(10.dp).fillMaxSize()) {
...
@Dark
@Composable
private fun HorizontalHealthSummaryComponent(
    modifier: Modifier = Modifier,
    title: String = stringResource(id = R.string.calories),
    ...
    ShapifyTheme {
        Card(
            modifier = modifier.width(400.dp).height(150.dp),
