...
@Preview
@Composable
private fun DayOfWeekItemComponentPreview() {
    MetricItemComponent(DateTimeUtil.getDayOfWeek(Calendar.getInstance().time).substring(0,2), "", PrimaryBlue, 15, Modifier)
}
